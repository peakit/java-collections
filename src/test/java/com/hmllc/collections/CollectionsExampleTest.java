...
class CollectionsExampleTest {
    ...
    public void testAddToEndOfLinkedList() {
        ...
        collectionsExample.addToEndOfLinkedList(numbers, 6);
    ...
    public void testAddToStartOfLinkedList() {
        LinkedList<Integer> numbers = new LinkedList<>(Arrays.asList(1, 2, 3, 4, 5));
        collectionsExample.addToStartOfLinkedList(numbers, 0);
    ...
    public void testRemoveItemFromTopOfStack() {
        ...
        stack.push(4);
        stack.push(5);
        collectionsExample.removeItemFromTopOfStack(stack);
    ...
    public void testRemoveItemFromFrontOfQueue() {
        ...
        queue.offer(4);
        queue.offer(5);
        collectionsExample.removeItemFromFrontOfQueue(queue);
    ...
    public void testAddItemToTreeSet() {
        ...
        set.add("orange");
        set.add("yellow");
        collectionsExample.addItemToTreeSet(set, "green");
